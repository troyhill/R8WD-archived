...
## Quality Control Data Assessment Report for the `r allSummary$data$OrganizationFormalName[1]` CWA106 Program (`r substr(head(allSummary$data$ActivityStartDate, 1), 1, 4)` - `r substr(tail(allSummary$data$ActivityStartDate,1), 1, 4)`)
